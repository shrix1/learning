...
const Page = () => {
  return (
    <main className="w-full h-screen bg-gray-500 text-black">
      <section className="m-5 flex flex-col ">
        ...
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            id="one"
            checked
            className="bg-sky-200 hover:bg-sky-300 rounded-sm bordder-none checked:bg-sky-500 checked:border-none  focus:ring-0
            focus:outline-none hover:checked:bg-sky-500 checked:ring-0 focus:checked:border-none focus:checked:bg-sky-500"
          />
        ...
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            id="two"
            checked
            className="bg-sky-500 hover:bg-sky-300 rounded-md border-none checked:bg-sky-500 checked:border-none focus:ring-0
            focus:outline-none hover:checked:bg-sky-500 checked:ring-0 focus:checked:border-none focus:checked:bg-sky-500"
          />
      ...
      <section className="m-5 flex flex-col">
        ...
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            name="three"
            id="three"
            className="bg-sky-200 border-4 border-white hover:bg-sky-300 rounded-lg  checked:bg-sky-500 checked:border-none focus:ring-0
            focus:outline-none hover:checked:bg-sky-500 checked:ring-0 focus:checked:border-none focus:checked:bg-sky-500"
          />
          <label htmlFor="three">3</label>
        </div>
