  ...
  return (
    <m.section ref={sectionRef} className="w-full grid grid-cols-2 gap-10">
      <m.div
        ...
        className="w-full rounded-lg bg-lime-500/50 p-7 text-white font-bold uppercase"
      >
        one
      </m.div>
      <m.div
        ...
        initial="hidden"
        animate={mainControls}
        transition={{ duration: 1, type: "spring", velocity: 2 }}
        className="w-full rounded-lg bg-lime-500/50 p-7 text-white font-bold uppercase"
      >
        two
      </m.div>
      <m.div
        ...
        initial="hidden"
        animate={mainControls}
        transition={{ duration: 1, delay: 0.4, type: "spring", velocity: 2 }}
        className="w-full rounded-lg bg-lime-500/50 p-7 text-white font-bold uppercase"
      >
        three
      </m.div>
      ...
      <m.div
        ...
        initial="hidden"
        animate={mainControls}
        transition={{ duration: 1, delay: 0.7, type: "spring", velocity: 2 }}
        className="w-full rounded-lg bg-lime-500/50 p-7 text-white font-bold uppercase"
      >
        five
      </m.div>
